...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <hr />
    <asp:SqlDataSource ID="sqlDS_Profesores" runat="server" ConnectionString='<%$ ConnectionStrings:t020009ConnectionString %>' DeleteCommand="DELETE FROM [Profesor] WHERE [ID_Profesor] = @original_ID_Profesor AND [nombres] = @original_nombres AND [apellido_paterno] = @original_apellido_paterno AND [apellido_materno] = @original_apellido_materno AND [numEmpleado] = @original_numEmpleado AND (([ID_Materia] = @original_ID_Materia) OR ([ID_Materia] IS NULL AND @original_ID_Materia IS NULL)) AND (([telefono] = @original_telefono) OR ([telefono] IS NULL AND @original_telefono IS NULL)) AND [email] = @original_email" InsertCommand="INSERT INTO [Profesor] ([nombres], [apellido_paterno], [apellido_materno], [numEmpleado], [ID_Materia], [telefono], [email]) VALUES (@nombres, @apellido_paterno, @apellido_materno, @numEmpleado, @ID_Materia, @telefono, @email)" SelectCommand="SELECT * FROM [Profesor]" UpdateCommand="UPDATE [Profesor] SET [nombres] = @nombres, [apellido_paterno] = @apellido_paterno, [apellido_materno] = @apellido_materno, [numEmpleado] = @numEmpleado, [ID_Materia] = @ID_Materia, [telefono] = @telefono, [email] = @email WHERE [ID_Profesor] = @original_ID_Profesor AND [nombres] = @original_nombres AND [apellido_paterno] = @original_apellido_paterno AND [apellido_materno] = @original_apellido_materno AND [numEmpleado] = @original_numEmpleado AND (([ID_Materia] = @original_ID_Materia) OR ([ID_Materia] IS NULL AND @original_ID_Materia IS NULL)) AND (([telefono] = @original_telefono) OR ([telefono] IS NULL AND @original_telefono IS NULL)) AND [email] = @original_email" ConflictDetection="CompareAllValues" OldValuesParameterFormatString="original_{0}">
        <DeleteParameters>
    ...
    <asp:DetailsView ID="dvAlumno" runat="server" Height="50px" Width="125px" AutoGenerateRows="False" DataKeyNames="ID_Profesor" DataSourceID="sqlDS_Profesores" DefaultMode="Insert" OnItemInserted="dvAlumno_ItemInserted" OnItemInserting="dvAlumno_ItemInserting">
        <Fields>
