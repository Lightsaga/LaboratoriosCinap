<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="LabFisica.aspx.cs" Inherits="Sistema_Horarios_Fisica" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="FeaturedContent" Runat="Server">
    <asp:TextBox ID="TextBox1" runat="server" BackColor="Aqua" Font-Size="XX-Large" Height="37px" ReadOnly="True" Width="645px">                  Laboratorio de Fisica
